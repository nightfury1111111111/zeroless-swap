...
import { Flex, Text, IconButton, AddIcon, MinusIcon, useModal, Skeleton } from '@sphynxdex/uikit'
...
const HasSharesActions: React.FC<HasStakeActionProps> = ({ pool, stakingTokenBalance }) => {
  ...
  const stakedDollarValue = cakePriceBusd.gt(0)
    ? getBalanceNumber(cakeAsBigNumber.multipliedBy(cakePriceBusd), stakingToken[chainId].decimals)
    : 0
