...
import { ModalBody, ModalContainer, Message, ModalHeader, Box, Heading } from '@sphynxdex/uikit'
...
const SwapWarningModal: React.FC<SwapWarningModalProps> = ({ swapCurrency, onDismiss }) => {
  ...
  const TOKEN_WARNINGS = {
    [getAddress(SwapWarningTokensConfig.safemoon.address, chainId)]: {
      symbol: SwapWarningTokensConfig.safemoon.symbol,
      component: <SafemoonWarning />,
    },
    [getAddress(SwapWarningTokensConfig.bondly.address, chainId)]: {
