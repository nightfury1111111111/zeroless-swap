...
export const fetchVaultFees = async (chainId) => {
  try {
    ...
    const [[performanceFee], [callFee], [withdrawalFee], [withdrawalFeePeriod]] = await multicallv2(cakeVaultAbi, calls, { requireSuccess: true }, chainId)
