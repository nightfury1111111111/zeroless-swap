...
function CurrencySearch({
  ...
  const showETH: boolean = useMemo(() => {
    ...
    return (s === '' || s === 'b' || s === 'bn' || s === 'bnb') && !isLimit
  }, [debouncedQuery, isLimit])

  const tokenComparator = useTokenComparator(invertSearchOrder)

  const filteredTokens: Token[] = useMemo(() => {
    return filterTokens(Object.values(allTokens), debouncedQuery, isBridge)
  ...
  const inactiveTokens = useFoundOnInactiveList(debouncedQuery, isBridge)
